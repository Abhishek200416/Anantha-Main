            ...
            <div className="p-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Configure your Razorpay API keys for payment processing. Keys are stored in the <code className="bg-gray-100 px-2 py-1 rounded text-xs">.env</code> file.
                  Get your keys from{' '}
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700 font-semibold">Configuration via .env File</p>
                      <p className="text-sm text-blue-600 mt-1">
                        Changes made here will update the backend <code className="bg-blue-100 px-1 rounded">.env</code> file and take effect immediately.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {razorpayKeysLoading ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      disabled={razorpayKeysLoading}
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all font-semibold shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {razorpayKeysLoading ? 'Saving...' : 'Save Razorpay Keys'}
                    </button>
                    ...
                    {razorpayKeysSaved && (
                      <div className="p-4 bg-green-100 text-green-800 rounded-lg flex items-center space-x-2">
                        ...
                        <span>✓ Razorpay API keys saved successfully to .env file!</span>
                      </div>
                    )}
                  </div>
                )}
